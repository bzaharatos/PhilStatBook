...
\end{quote}
\begin{flushright}
— Karl Pearson, \textit{The New Werther}\footnote{Pearson, K. (1880). \textit{The New Werther}. London: Edward Arnold.}
\end{flushright}
...
\end{quote}
\begin{flushright}
— Lawrence Krauss, interview in The Atlantic\footnote{Andersen, R. (2012, April 23). \textit{Has physics made philosophy and religion obsolete?} The Atlantic. \url{https://archive.ph/0sbZe}}
\end{flushright}
...
First uses of the sample mean as a measure of center in the social sciences saw criticisms along these lines. For example, as reported in \citet{Stigler2016}, the Belgian statistician Adolphe Quetelet used the mean as a way of comparing human populations with respect to a particular variable---e.g., height. \citet{Stigler2016} writes:
\begin{quote}
...
Consider a thought experiment given by Sir Ronald Fisher in his 1935 work {\it Design of Experiments} (\citet{Fisher1935}). A woman at a tea party---let's call her Elaine--- claims that, without looking, she is able to distinguish between two scenarios about a given cup of tea:
\begin{enumerate}
...
Broadly, the use of a probability model to make comparative judgements about data is what we mean by the likelihood pillar. \citet{Stigler2016} writes that 
\begin{quote}
...
\begin{figure}
\centering
\includegraphics[scale = 0.5]{figures/scatter.png}
...
\begin{figure}
\centering
\includegraphics[scale = 0.5]{figures/cars_qq.png}
...
\begin{figure}
\centering
\includegraphics[scale = 0.5]{figures/cars_fit_resid.png}
...
%
%\includegraphics[scale = 0.5]{figures/money-spent-dist.png}
%
